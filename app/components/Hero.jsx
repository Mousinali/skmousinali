  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        <div className="blob-1 absolute -top-40 -left-40 w-[520px] h-[520px] rounded-full bg-indigo-200/45 blur-[120px]" />
        <div className="blob-2 absolute top-1/3 -right-40 w-[520px] h-[520px] rounded-full bg-sky-200/45 blur-[120px]" />
        <div className="blob-3 absolute -bottom-40 left-1/3 w-[520px] h-[520px] rounded-full bg-purple-200/40 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl leading-[1.2] tracking-tight">
          <span className="block overflow-hidden">
            <span className="hero-line block">
              <span className="font-medium text-gray-500">UI/UX Designer</span>{" "}
        ...
        <p className="hero-fade mt-6 max-w-2xl mx-auto text-gray-500 text-base md:text-lg">
          Beautifully designed, easy-to-use websites that help you stand out and connect with your audience.
        </p>

        <div className="hero-fade mt-10 flex justify-center gap-4">
          <Link href="/lets-talk" className="rounded-full bg-black text-white px-6 py-3 text-sm font-medium">
            Let’s Talk
          </Link>
          <Link href="/contact" className="rounded-full bg-gray-100 text-gray-900 px-6 py-3 text-sm font-medium">
            Email Me
          </Link>
        </div>
      </div>
      ...
      <div className="relative z-10 mt-24 overflow-hidden max-w-7xl mx-auto">
        <div ref={marqueeRef} className="flex gap-8 items-center px-24">
          {[...projects, ...projects].map((item, i) => (
            <div key={i} className="min-w-[320px] sm:min-w-[360px] overflow-hidden">
              <img src={item.image} alt={item.title} className="w-full rounded-2xl" draggable="false" />
            </div>
          ))}
        </div>
      </div>
