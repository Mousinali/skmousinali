    ...
    >
      ...
      <div ref={pinRef} className="py-40">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <h2 className="mx-auto max-w-4xl text-3xl sm:text-4xl 2xl:text-5xl leading-[1.25] tracking-tight text-gray-900 flex flex-wrap justify-center gap-x-2">
            {[
              "I", "design", "thoughtful", "digital", "experiences",
              "that", "balance", "aesthetics,", "usability,", "and",
              "business", "impact."
            ].map((word, i) => (
              <span key={i} className="about-word inline-block font-medium">
                {word}
              </span>
            ))}
          </h2>
