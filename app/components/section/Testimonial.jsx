...
export default function ResultsTestimonials() {
    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none absolute inset-0">
                <div
                    className="absolute -top-40 -left-32 w-[420px] h-[420px]
          bg-gradient-to-br from-emerald-200 via-lime-200 to-yellow-200
          rounded-full blur-[140px] opacity-40
          animate-[blob_22s_ease-in-out_infinite]"
                />

                <div
                    className="absolute top-1/3 -right-40 w-[480px] h-[480px]
          bg-gradient-to-br from-indigo-200 via-purple-200 to-pink-200
          rounded-full blur-[160px] opacity-35
          animate-[blob_26s_ease-in-out_infinite_reverse]"
                />

                <div
                    className="absolute bottom-0 left-1/4 w-[360px] h-[360px]
          bg-gradient-to-br from-cyan-200 via-teal-200 to-emerald-200
          rounded-full blur-[120px] opacity-30
          animate-[blob_30s_ease-in-out_infinite]"
                />
            </div>
            ...
            <div className="relative max-w-7xl mx-auto">
                ...
                <div className="grid gap-8 md:grid-cols-3 auto-rows-fr">
                    ...
                    <div
                        ...
                        className="md:row-span-2 rounded-[28px]
    ...
    p-12 flex flex-col justify-between"
                    >
                        ...
                        <p className="text-sm text-gray-500 mt-10 leading-relaxed">
                            “What felt overwhelming at first turned into a smooth and surprisingly fast
                            launch process.”
                        </p>
                    </div>
    ...
    border border-black/15
    shadow-[0_20px_60px_-25px_rgba(0,0,0,0.14)]
    ...
    p-10 flex flex-col justify-between"
                    >
                        <p className="text-gray-800 text-lg leading-relaxed">
                            “Their clarity and attention to detail completely changed how we approached
                            our contracts.”
                        </p>
    ...
    p-10 flex flex-col justify-between"
                    >
                        <p className="text-gray-800 text-lg leading-relaxed">
                            “Everything moved faster than expected — from planning to execution.
                            It felt structured, calm, and well thought out.”
                        </p>
